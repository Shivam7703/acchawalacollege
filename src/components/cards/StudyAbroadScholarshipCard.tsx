...
export default function AbroadCourseCard({ course }: CourseCardProps) {
  return (
        ...
        <div className="flex gap-y-2 p-5 max-md:flex-wrap">
          ...
          <div className="md:px-5">
            ...
            <div className="flex justify-between w-full">
              ...
              <div className="flex items-center gap-x-1 text-3xl flex-end">
                <Link href="#">
                  <CiHeart />
                </Link>
            ...
            <Link href={course.readMore}>
              <h1 className="mb-2 xl:mb-3 text-wrap text-[24px] font-bold text-center hover:text-blue-500 leading-none xl:text-[26px]">
                {course.name}
              </h1>
            </Link>
            {/* Line 3 */}
            <div className="mb-2 xl:mb-3 flex flex-wrap gap-x-12 gap-y-4 justify-center">
              {/* item 1 */}
              ...
              <div className="flex flex-col">
                <div className="flex gap-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-zinc-400">Population</p>
                  </div>
                </div>
              </div>
              {/* item 3  */}
              <div className="flex flex-col">
                <div className="flex gap-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-zinc-400">No. of Scholarship</p>
                  </div>
                </div>
              </div>
            </div>
