...
export const Input = React.forwardRef(function Input(
  ...
  return (
    <div className="relative mt-5 h-11 w-full">
      <input
        type={type}
        className={`border-blue-gray-200 text-blue-gray-700 placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 peer h-full w-full rounded-md border bg-transparent bg-white px-3 py-3 font-sans text-sm font-normal outline outline-0 transition-all placeholder-shown:border focus:border-2 focus:border-blue-500 focus:border-t-transparent focus:outline-0 ${className}`}
        ref={ref}
        {...props}
        id={id}
        placeholder=" "
