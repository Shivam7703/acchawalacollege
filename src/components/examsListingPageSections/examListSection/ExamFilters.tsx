...
export default function ExamFilters({
  ...
  mobileFilter,
  setMobileFilter,
  StreamCheckedFilters,setStreamCheckedFilters,ModeCheckedFilters,setModeCheckedFilters,LevelCheckedFilters,setLevelCheckedFilters,
}: any) {
  ...
  const handleModeFilter = (data: string) => {
    ...
    const updatedSelection = ModeCheckedFilters.includes(data)
      ? ModeCheckedFilters.filter((item: string) => item !== data)
  ...
  const handleLevelFilter = (data: string) => {
    ...
    const updatedSelection = LevelCheckedFilters.includes(data)
      ? LevelCheckedFilters.filter((item: string) => item !== data)
