...
const Stepper = (props: StepperProps) => {
  const {
    ...
    stroke = 2,
    activeColor = "#2563EB",
    activeProgressBorder = "2px double #2563EB",
    ...
    if ((children as React.ReactElement[]).length > 1 && showProgressBar) {
      ...
      (children as React.ReactElement[]).map((_child, ind) => {
        ...
        if (element.classList.length > 1) {
          ...
          element.style.border = "2px double #2563EB";
        }
      });
    }
  }, [active]);
              ...
              {(children as React.ReactElement[]).map((_child, ind) => {
                return (
                  ...
                  <div key={ind} className="flex flex-col items-center">
                    ...
                    <p className="mt-2.5 text-sm font-semibold text-blue-8zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz00 max-sm:hidden sm:text-xs">
